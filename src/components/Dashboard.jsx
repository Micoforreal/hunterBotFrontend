  ...
  return <div className="flex-1 overflow-auto">
      <header className="px-6 py-4 flex justify-between items-center border-b border-gray-200">
        ...
        <div className="flex items-center">
          <div className="text-right mr-3">
            ...
            <div className="font-bold">Joe</div>
          </div>
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-3 gap-6 mb-8">
          <StatsCard title="Total Jobs Found" value="2,970" progress={75} color="purple" />
          <StatsCard title="Total Connections" value="1,798" progress={65} color="purple" />
